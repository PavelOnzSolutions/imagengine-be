...
import solutions.onz.services.imagengine.observability.SecurityMetersService;
...
public class JwtConfiguration {
    @Value("${imagengine.security.jwt-base64-secret}")
    ...
    private SecretKey getSecretKey() {
        byte[] keyBytes = Base64.from(jwtBase64Key).decode();
