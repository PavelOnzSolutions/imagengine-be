...
import solutions.onz.services.imagengine.utils.web.ExceptionTranslation;
...
public class ReactiveWebExceptionHandler implements org.springframework.web.server.WebExceptionHandler {
    ...
    private Mono<Void> setHttpResponse(final ResponseEntity<Object> entity, final ServerWebExchange exchange, final ObjectMapper mapper) {
