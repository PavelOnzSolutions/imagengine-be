...
import solutions.onz.services.imagengine.services.dto.UserDTO;
import solutions.onz.services.imagengine.services.exception.EmailAlreadyUsedException;
import solutions.onz.services.imagengine.services.exception.InvalidPasswordException;
import solutions.onz.services.imagengine.services.exception.UsernameAlreadyUsedException;
import solutions.onz.services.imagengine.utils.security.RandomUtil;
import solutions.onz.services.imagengine.utils.security.SecurityUtil;
...
public class UserService {
    ...
    private void UserDTOToUser(AdminUserDTO userDTO, User user) {
    ...
    public Flux<AdminUserDTO> getAllManagedUsers() {
        return userRepository.findAllByIdNotNull().map(AdminUserDTO::new);
    }
